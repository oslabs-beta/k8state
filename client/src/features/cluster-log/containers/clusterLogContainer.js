          ...
          _jsxs(Dialog, {
            ...
            children: [
              _jsx(DialogTitle, {
                ...
                children: "Are you sure you want to delete all logs?",
              }),
              _jsx(DialogContent, {
                children: _jsx(DialogContentText, {
                  id: "alert-dialog-description",
                  children:
                    "This action is irreversable, please confirm you would like to delete ALL logs.",
                }),
              }),
              _jsxs(DialogActions, {
                children: [
    ...
    _jsxs("div", {
      ...
      children: [
        ...
        clusterLogs?.map((clusterLog, i) =>
          _jsx(ClusterLog, { clusterLog: clusterLog }, `clusterLog:${i}`),
        ),
        _jsx("div", {
