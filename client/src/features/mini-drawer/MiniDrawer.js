    ...
    children: [
        ...
        children: _jsxs(Toolbar, {
          children: [
            ...
            _jsxs(Typography, {
              ...
              children: [
                "K",
                _jsx("span", { style: { color: "#ad97d0" }, children: "8" }),
                "STATE \u2014 Cluster View",
              ],
            }),
            _jsx("img", {
      ...
      _jsxs(Drawer, {
        ...
        children: [
          ...
          _jsx(Divider, {}),
          _jsx(List, {
            children: ["Settings", "Github"].map((text, index) =>
              _jsx(
                ListItem,
                {
                  onClick: () => handleMenuSelect(text),
      ...
      _jsxs(Drawer, {
        ...
        children: [
          ...
          _jsx(Typography, { children: "Testing" }),
        ],
      }),
      _jsxs("main", {
        children: [
          selectedPage === "ClusterUI" && _jsx(ClusterViewContainer, {}),
          selectedPage === "Logs" && _jsx(ClusterLogContainer, {}),
          selectedPage === "Grafana Dashboard" &&
            _jsx(GrafanaViewContainer, {}),
          selectedPage === "Prometheus Charts" &&
            _jsx(PrometheusViewContainer, {}),
          selectedPage === "Settings" && _jsx(Settings, {}),
          selectedPage === "Github" && _jsx(LandingPage, {}),
        ],
      }),
    ],
  })
